...
- Visual readiness report status, including the `scripts/visual_readiness_report.js` command and any failed checks such as `artifact-freshness` or `evidence-freshness`.
